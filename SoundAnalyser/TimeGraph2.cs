...
namespace Interface
{
    public partial class TimeGraph2 : Form
    {
        ...
        private void chartSetup()
        {
            ...
            s1 = new Series("Right Channel");
            s1.ChartType = SeriesChartType.FastLine;
            s1.BorderWidth = 2;
            s1.Color = myColor;
            chart1.Series.Add(s1);

            chart1.Titles.Add("Right Channel Wave");
        ...
        public void chartDisplay2(double[] x, double[] y)
        {
            ...
            if(x == null || y == null)
            {
                MessageBox.Show("No right channel data");
                x = new double[1];
                y = new double[1];
            }
        ...
        /// <summary>
        /// Copies selected sample values for forward fourier
        /// </summary>
        ...
        /// <summary>
        /// Applies square windowing technique to selected values
        /// </summary>
        /// <param name="sender">Window</param>
        /// <param name="e">Event</param>
        ...
        /// <summary>
        /// Applies triangle windowing technique to selected values
        /// </summary>
        /// <param name="sender">Window</param>
        /// <param name="e">Event</param>
