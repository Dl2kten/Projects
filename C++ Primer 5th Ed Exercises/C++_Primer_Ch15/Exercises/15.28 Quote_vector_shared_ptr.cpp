...
/*
* Exercise 15.28, 15.29
* Define a vector to hold Quote objects but put Bulk_quote objects into
* that vector, compute total net_price of all the elements
* Change vector type from Quote objects to shared_ptrs of Quote objects
*/
...
int main() {
	...
	std::cout << "The total price of all books is: " << total_price
		<< "\n\n" << std::endl;
	//discount applied because net_price versions change based on dynamic
	//type of object pointed to by pointer
