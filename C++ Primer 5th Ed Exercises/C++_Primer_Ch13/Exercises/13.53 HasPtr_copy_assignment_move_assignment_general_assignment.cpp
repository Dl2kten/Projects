...
* and compare operations executre in your new move-assignment operator
...
int main() {
	...
	/*
	* The general assignment operator is not ideal for low level
	* efficiency because the param is a done is copying and if move-
	* assignment not defined than it would opt to use copy-assignment
	*/
	return 0;
}