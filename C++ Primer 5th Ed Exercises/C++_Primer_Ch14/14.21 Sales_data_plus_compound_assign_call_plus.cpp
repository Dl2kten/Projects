...
/*
* Exercise 14.21
* Write Sales_data class so + does the actual addition and += calls +,
...
int main() {
	...
	std::cout << sd4;
	/*
	* Disadvantages of using + to do actual operations over += is that
	* + returns a copy and have to give + friend status which gives an
	* extra member access to private
	*/
	return 0;
}