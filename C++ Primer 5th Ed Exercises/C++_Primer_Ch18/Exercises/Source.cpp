...
public:
	...
	//prob didn't need this part for Final as question asked for each derived
	//to use its arg to initialize Base part, Final not direct derived of Base,
	//same for MI above
...
int main() {
	...
	*/
	...
	//D1 and D2 are ignored, ooh wait that's why all derived classes should
